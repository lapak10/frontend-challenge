...
import { MDBTable, MDBTableBody, MDBTableHead,MDBBtn,MDBNav,MDBRow,MDBContainer, MDBCard, MDBCardBody, MDBCardImage, MDBCardTitle, MDBCardText, MDBCol } from 'mdbreact';
...
export default class SeasonDetail extends Component {
   // https://ergast.com/api/f1/2006/results/1.json
   constructor(props) 
   { 
       super(props);
